...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 20. Nov 2016 um 19:09
...
INSERT INTO `courses` (`id`, `name`, `description`, `creator`, `contact`, `language`, `links`, `edit_date`, `subject_id`)
VALUES
  (1, 'Social Entrepreneurship 101', 'This course introduces the basic principles of Social Entrepreneurship', 132,
   'Peter Sommerhoff', 1, 'http://petersommerhoff.com', '2016-11-20 18:04:43', 1),
  (2, 'Flight Booking Course', 'In this course you will learn to book flights for a customer.', 133, 'Tilman Berres', 1,
   '', '2016-11-20 18:04:34', 66);
